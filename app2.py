...
with st.sidebar:
    st.image("https://dimensionless.in/wp-content/uploads/2019/02/cover_tree.jpeg", width=350)
...
if app_mode == "Prediction Tool":
    ...
    template_df = pd.DataFrame({
        ...
        'CreditScore': [720, 650, 590],
        'Age': [42, 35, 28],
        'Balance': [52000, 76000, 48000],
        'EstimatedSalary': [65000, 48000, 85000]
    })
